...
- [61_instagram_repost.md](61_instagram_repost.md) - Instagram reel/post repost: yt-dlp only (no mirror), no audio gate, photo/carousel decline, shared repost pipeline, `INSTAGRAM_PROXY` / `INSTAGRAM_COOKIES`
